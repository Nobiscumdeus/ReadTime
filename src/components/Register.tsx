    ...
    return (
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">The verification link will expire in 24 hours.</p>
          <button
  ...
  return (
    <div>
      ...
      <div className="mt-6 text-center text-sm text-gray-600">
        ...
        <a href="#" className="cursor-pointer text-indigo-600 hover:text-indigo-800 font-medium" onClick={() => navigate('/login')}>
          Sign in
        </a>
      </div>
    </div>
